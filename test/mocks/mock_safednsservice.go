...
func (m *MockSafeDNSService) GetTemplateRecordsPaginated(arg0 int, arg1 connection.APIRequestParameters) ([]safedns.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockSafeDNSService) GetTemplatesPaginated(arg0 connection.APIRequestParameters) ([]safedns.Template, error) {
	m.ctrl.T.Helper()
...
func (m *MockSafeDNSService) GetZoneNotesPaginated(arg0 string, arg1 connection.APIRequestParameters) ([]safedns.Note, error) {
	m.ctrl.T.Helper()
...
func (m *MockSafeDNSService) GetZoneRecordsPaginated(arg0 string, arg1 connection.APIRequestParameters) ([]safedns.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockSafeDNSService) GetZonesPaginated(arg0 connection.APIRequestParameters) ([]safedns.Zone, error) {
	m.ctrl.T.Helper()
