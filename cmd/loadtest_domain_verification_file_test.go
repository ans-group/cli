...
func Test_loadtestDomainVerificationFileVerifyCmd_Args(t *testing.T) {
	t.Run("ValidArgs_NoError", func(t *testing.T) {
		err := loadtestDomainVerificationFileVerifyCmd().Args(nil, []string{"00000000-0000-0000-0000-000000000000"})

		assert.Nil(t, err)
	})

	t.Run("InvalidArgs_Error", func(t *testing.T) {
		err := loadtestDomainVerificationFileVerifyCmd().Args(nil, []string{})
