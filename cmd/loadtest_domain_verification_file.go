...
func loadtestDomainVerificationFileRootCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "file",
	...
	// Child commands
	cmd.AddCommand(loadtestDomainVerificationFileVerifyCmd())

	return cmd
}

func loadtestDomainVerificationFileVerifyCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return loadtestDomainVerificationFileVerify(getClient().LTaaSService(), cmd, args)
		},
	}
}
