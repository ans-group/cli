...
func Test_loadtestThresholdList(t *testing.T) {
	...
	t.Run("GetThresholdsError_ReturnsError", func(t *testing.T) {
...
func Test_loadtestThresholdShowCmd_Args(t *testing.T) {
	t.Run("ValidArgs_NoError", func(t *testing.T) {
		err := loadtestThresholdShowCmd(nil).Args(nil, []string{"123"})

		assert.Nil(t, err)
	})

	t.Run("InvalidArgs_Error", func(t *testing.T) {
		err := loadtestThresholdShowCmd(nil).Args(nil, []string{})
